...
package com.example.pointearning.zxing.view;
...
public final class ViewfinderView extends View {
  ...
  public void onDraw(Canvas canvas) {
    ...
    // Draw the exterior (ic_home_lcxm.ic_home_wz. outside the framing rect) darkened
...
//      canvas.drawRect(frame.left, scannerStart, frame.right, scannerStart + SCANNER_LINE_HEIGHT, paint);
  ...
  // 绘制模糊区域 Draw the exterior (ic_home_lcxm.ic_home_wz. outside the framing rect) darkened
