...
public class HomeAdapter extends RecyclerView.Adapter {
    ...
    public HomeAdapter(List<NewsEntity> mDataList, Context mContext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case VIEW_TYPE_ONE:
                viewHolder = new ViewHolderOne(inflater.inflate(R.layout.main_fragment_item1banner, parent, false));
                break;
            case VIEW_TYPE_TWO:
...
//                        ImageView iv = new ImageView(mContext);
                        ImageView iv = (ImageView) View.inflate(mContext, R.layout.item_banner, null);
...
//                                当手指离开viewpager时开始自动轮播
    ...
    public HomeAdapter(List<NewsEntity> iconList) {
        mDataList = iconList;
    }
